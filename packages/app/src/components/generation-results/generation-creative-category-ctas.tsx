...
function GenerationCreativeCategoryCtas() {
  return (
    <div
      ...
      className="mx-auto grid w-full max-w-[42rem] grid-cols-3 gap-2"
      role="group"
    >
      <CreativeCategoryCta
        label="Film"
