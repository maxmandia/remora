...
BEGIN
  ...
  IF EXISTS (
    ...
    WHERE "id" = 'tripo-h3-1-text-to-3d'
      AND (
        "provider_id" <> 'tripo'
        OR "type" <> 'model3d'
      )
  ) THEN
    RAISE EXCEPTION 'Immutable generation model identity does not match: tripo-h3-1-text-to-3d';
  END IF;
END
...
BEGIN
  IF EXISTS (
    ...
    WHERE "id" = 'tripo-h3-1-text-to-3d-v1'
      AND (
        "model_id" <> 'tripo-h3-1-text-to-3d'
        OR "version" <> 1
        OR "schema_version" <> 1
        OR (
          "status" <> 'draft'
...
BEGIN
  IF EXISTS (
    ...
    WHERE "id" = 'tripo-h3-1-text-model-none-standard'
      AND (
        "model_spec_id" <> 'tripo-h3-1-text-to-3d-v1'
    ...
    RAISE EXCEPTION 'Generation model rate identity is immutable: tripo-h3-1-text-model-none-standard';
  END IF;
END
...
INSERT INTO "generation_model_rate" (
  ...
  'tripo-h3-1-text-model-none-standard',
  'tripo-h3-1-text-to-3d-v1',
  'output_model3d',
...
BEGIN
  IF EXISTS (
    SELECT 1 FROM "generation_model_rate"
    WHERE "id" = 'tripo-h3-1-text-model-standard-standard'
      AND (
        "model_spec_id" <> 'tripo-h3-1-text-to-3d-v1'
        OR "component" <> 'output_model3d'
        OR "quantity_source" <> 'output_model3d_count'
    ...
    RAISE EXCEPTION 'Generation model rate identity is immutable: tripo-h3-1-text-model-standard-standard';
  END IF;
END
$model_rate$;--> statement-breakpoint
INSERT INTO "generation_model_rate" (
  ...
  'tripo-h3-1-text-model-standard-standard',
  'tripo-h3-1-text-to-3d-v1',
  'output_model3d',
  'output_model3d_count',
  NULL,
...
BEGIN
  IF EXISTS (
    SELECT 1 FROM "generation_model_rate"
    WHERE "id" = 'tripo-h3-1-text-model-detailed-standard'
      AND (
        "model_spec_id" <> 'tripo-h3-1-text-to-3d-v1'
        OR "component" <> 'output_model3d'
        OR "quantity_source" <> 'output_model3d_count'
    ...
    RAISE EXCEPTION 'Generation model rate identity is immutable: tripo-h3-1-text-model-detailed-standard';
  END IF;
END
$model_rate$;--> statement-breakpoint
INSERT INTO "generation_model_rate" (
  ...
  'tripo-h3-1-text-model-detailed-standard',
  'tripo-h3-1-text-to-3d-v1',
  'output_model3d',
  'output_model3d_count',
  NULL,
...
BEGIN
  IF EXISTS (
    SELECT 1 FROM "generation_model_rate"
    WHERE "id" = 'tripo-h3-1-text-model-none-detailed'
      AND (
        "model_spec_id" <> 'tripo-h3-1-text-to-3d-v1'
        OR "component" <> 'output_model3d'
        OR "quantity_source" <> 'output_model3d_count'
    ...
    RAISE EXCEPTION 'Generation model rate identity is immutable: tripo-h3-1-text-model-none-detailed';
  END IF;
END
$model_rate$;--> statement-breakpoint
INSERT INTO "generation_model_rate" (
  ...
  'tripo-h3-1-text-model-none-detailed',
  'tripo-h3-1-text-to-3d-v1',
  'output_model3d',
  'output_model3d_count',
  NULL,
...
BEGIN
  IF EXISTS (
    SELECT 1 FROM "generation_model_rate"
    WHERE "id" = 'tripo-h3-1-text-model-standard-detailed'
      AND (
        "model_spec_id" <> 'tripo-h3-1-text-to-3d-v1'
        OR "component" <> 'output_model3d'
        OR "quantity_source" <> 'output_model3d_count'
    ...
    RAISE EXCEPTION 'Generation model rate identity is immutable: tripo-h3-1-text-model-standard-detailed';
  END IF;
END
$model_rate$;--> statement-breakpoint
INSERT INTO "generation_model_rate" (
  ...
  'tripo-h3-1-text-model-standard-detailed',
  'tripo-h3-1-text-to-3d-v1',
  'output_model3d',
  'output_model3d_count',
  NULL,
...
BEGIN
  IF EXISTS (
    SELECT 1 FROM "generation_model_rate"
    WHERE "id" = 'tripo-h3-1-text-model-detailed-detailed'
      AND (
        "model_spec_id" <> 'tripo-h3-1-text-to-3d-v1'
        OR "component" <> 'output_model3d'
        OR "quantity_source" <> 'output_model3d_count'
    ...
    RAISE EXCEPTION 'Generation model rate identity is immutable: tripo-h3-1-text-model-detailed-detailed';
  END IF;
END
$model_rate$;--> statement-breakpoint
INSERT INTO "generation_model_rate" (
  ...
  'tripo-h3-1-text-model-detailed-detailed',
  'tripo-h3-1-text-to-3d-v1',
  'output_model3d',
  'output_model3d_count',
  NULL,
...
BEGIN
  IF EXISTS (
    ...
    WHERE "id" = 'tripo-h3-1-text-v1-concurrent'
      AND (
        "model_spec_id" <> 'tripo-h3-1-text-to-3d-v1'
        OR "bucket_id" <> 'tripo-h3-1-concurrent-task'
      )
  ) THEN
    RAISE EXCEPTION 'Generation model rate-limit identity is immutable: tripo-h3-1-text-v1-concurrent';
  END IF;
END
