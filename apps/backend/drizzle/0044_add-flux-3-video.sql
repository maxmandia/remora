...
INSERT INTO "generation_model_rate" (
  ...
  1,
  170000,
  '{"outputResolution":"hd","inputIncludesVideo":false,"draft":false}'::jsonb
)
ON CONFLICT ("id") DO UPDATE SET
...
INSERT INTO "generation_model_rate" (
  ...
  1,
  290000,
  '{"outputResolution":"fhd","inputIncludesVideo":false,"draft":false}'::jsonb
)
ON CONFLICT ("id") DO UPDATE SET
  "unit_quantity" = excluded."unit_quantity",
  "unit_price_usd_micros" = excluded."unit_price_usd_micros",
...
INSERT INTO "generation_model_rate" (
  ...
  1,
  430000,
  '{"outputResolution":"hd","inputIncludesVideo":true,"draft":false}'::jsonb
)
ON CONFLICT ("id") DO UPDATE SET
  "unit_quantity" = excluded."unit_quantity",
  "unit_price_usd_micros" = excluded."unit_price_usd_micros",
...
INSERT INTO "generation_model_rate" (
  ...
  1,
  540000,
  '{"outputResolution":"fhd","inputIncludesVideo":true,"draft":false}'::jsonb
)
ON CONFLICT ("id") DO UPDATE SET
  "unit_quantity" = excluded."unit_quantity",
  "unit_price_usd_micros" = excluded."unit_price_usd_micros",
...
BEGIN
  IF EXISTS (
    SELECT 1 FROM "generation_model_rate"
    WHERE "id" = 'flux-3-video-output-video-draft-input-video-off'
      AND (
        "model_spec_id" <> 'flux-3-video-v1'
        OR "component" <> 'output_video'
        OR "quantity_source" <> 'output_duration_seconds'
    ...
    RAISE EXCEPTION 'Generation model rate identity is immutable: flux-3-video-output-video-draft-input-video-off';
  END IF;
END
$model_rate$;--> statement-breakpoint
INSERT INTO "generation_model_rate" (
  ...
  'flux-3-video-output-video-draft-input-video-off',
  'flux-3-video-v1',
  'output_video',
  'output_duration_seconds',
  NULL,
  ...
  1,
  60000,
  '{"inputIncludesVideo":false,"draft":true}'::jsonb
)
ON CONFLICT ("id") DO UPDATE SET
  "unit_quantity" = excluded."unit_quantity",
  "unit_price_usd_micros" = excluded."unit_price_usd_micros",
...
BEGIN
  IF EXISTS (
    SELECT 1 FROM "generation_model_rate"
    WHERE "id" = 'flux-3-video-output-video-draft-input-video-on'
      AND (
        "model_spec_id" <> 'flux-3-video-v1'
        OR "component" <> 'output_video'
        OR "quantity_source" <> 'output_duration_seconds'
    ...
    RAISE EXCEPTION 'Generation model rate identity is immutable: flux-3-video-output-video-draft-input-video-on';
  END IF;
END
$model_rate$;--> statement-breakpoint
INSERT INTO "generation_model_rate" (
  ...
  'flux-3-video-output-video-draft-input-video-on',
  'flux-3-video-v1',
  'output_video',
  'output_duration_seconds',
  NULL,
  ...
  1,
  120000,
  '{"inputIncludesVideo":true,"draft":true}'::jsonb
)
ON CONFLICT ("id") DO UPDATE SET
  "unit_quantity" = excluded."unit_quantity",
  "unit_price_usd_micros" = excluded."unit_price_usd_micros",
